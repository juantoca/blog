...
description: Como acabé frustrado del mapa del catastro y el análisis técnico que hice
date: 2024-01-01
draft: false
---
...
Os presento el [mapa del catastro](https://www1.sedecatastro.gob.es/cartografia/mapa.aspx). A primera vista, puede parecer que el mapa es *responsive*. Invito al lector a hacer zoom hasta que se empiece a ver la información catastral:

![Inmuebles presentes al subir por la alameda primera dirección a la fuente de Cajo](./catastro-example.png)
